...
public class CoffeeMakerServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        Logger.debug("Logger: CoffeeMakerServlet init()");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Logger.debug("Logger: Servlet request " + request.getMethod() + " "
        ...
        if (action == null) {
            ...
            Logger.trace("Logger: Executing action: {}", action);
            switch (action) {
                case "turnOnOff":
                    cm.pressOnOff();
                    break;
        ...
        Logger.debug("Logger: jsonResponse: " + jsonResponse.toString());
